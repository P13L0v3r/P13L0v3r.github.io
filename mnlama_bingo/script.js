const bingo_items = {
    meta: [
        ...
        "You were on time",
        "Cat was late",
        "Cat doesn't do a character voice",
        "Cat doesn't do a character voice",
        ...
        "You ask a plot relevant question",
        "You check in on another player who's been excluded or quiet",
    ],
    character: [
        ...
        "Niki talks to an animal",
        "Darius makes some food",
        "Felix makes some food",
    ],
    roleplay: [
